(function(){
  ...
  // keep the sticky qty-toggle pinned just below the sticky nav, whatever its rendered height is
  const navBarEl=document.querySelector('nav');
  function syncNavHeight(){
    if(navBarEl) document.documentElement.style.setProperty('--navH', navBarEl.offsetHeight+'px');
  }
  syncNavHeight();
